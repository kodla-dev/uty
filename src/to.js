/**
  Data Transformation
  --------------------------------------------------------------------------------------------------
  It changes variable and constant types and values.
  --------------------------------------------------------------------------------------------------
*/

import { values } from './collect.js';
import { isArray, isAsyncIterable, isCollect, isObject, isPromise, isUndefined } from './is.js';

/**
 * Converts a value to an array.
 * @param {*} [collect] - The value to convert to an array.
 * @returns {Array|Promise<Array>|function} The resulting array or a partially applied function.
 */
 ...
 * @returns {Promise<Array>} - Resolves to an array of the iterable items.
 */
...
/**
 * Converts the specified collection to a string representation. (using JSON.stringify)
